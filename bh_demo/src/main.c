...
unsigned char HeartBeat[Num_Of_Package]={0x60,0x00,0x01,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0xff};//heartbeat;
unsigned char LogOn [Num_Of_Package]={0x60,0x00,0x01,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0xff};//LogOn the tcp server;
unsigned char DataOut[Num_Of_Package]={0x60,0x00,0x01,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0xff};//传输检测数据
